...
# الصلاة: النقاط باللون الأحمر
        options_1 = {
            "في المسجد جماعة <span style='color:red;'>= 5 نقاط</span>": 5,
            "في المنزل جماعة <span style='color:red;'>= 4 نقاط</span>": 4,
            "في المسجد منفرد <span style='color:red;'>= 4 نقاط</span>": 4,
            "في المنزل منفرد <span style='color:red;'>= 3 نقاط</span>": 3,
            "خارج الوقت <span style='color:red;'>= 0 نقاط</span>": 0
        }
        
        for col in columns[1:6]:
            st.markdown(f"<h4 style='font-weight: bold;'>{col}</h4>", unsafe_allow_html=True)
            selected = st.radio(
                "", list(options_1.keys()), index=0, key=col, format_func=lambda x: x,  # no formatting
            )
            values.append(str(options_1[selected]))
        
        # الأذكار: النقاط باللون الأحمر
        checkbox_options = {
            "الفجر <span style='color:red;'>= 1 نقطة</span>": 1,
            "الظهر القبلية <span style='color:red;'>= 1 نقطة</span>": 1,
            "العصر القبلية <span style='color:red;'>= 1 نقطة</span>": 1,
            "المغرب <span style='color:red;'>= 1 نقطة</span>": 1,
            "العشاء <span style='color:red;'>= 1 نقطة</span>": 1
        }
        ...
        for option_html, value in checkbox_options.items():
            with checkbox_cols[0]:
                if st.checkbox(label=option_html, key=f"{columns[6]}_{option_html}"):
                    selected_checkboxes.append(value)
        
        score_checkbox = len(selected_checkboxes)  # كل خيار = 1 نقطة
        values.append(str(score_checkbox))
        
        # قراءة القرآن: النقاط باللون الأحمر
        time_read_options = {
            "قرأته لفترتين <span style='color:red;'>= 4 نقاط</span>": 4,
            "قرأته مرة واحدة في اليوم <span style='color:red;'>= 2 نقطة</span>": 2,
            "لم أتمكن من قراءته لهذا اليوم <span style='color:red;'>= 0 نقاط</span>": 0
        }
        ...
        yes_no_options_2pts = {
            "نعم <span style='color:red;'>= 2 نقطة</span>": 2,
            "لا <span style='color:red;'>= 0 نقطة</span>": 0
        }
        ...
        yes_no_options_1pt = {
            "نعم <span style='color:red;'>= 1 نقطة</span>": 1,
            "لا <span style='color:red;'>= 0 نقطة</span>": 0
        }
